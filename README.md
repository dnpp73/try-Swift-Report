...
<div><a href="941/2016-03-03 14.39.40.jpg"><img src="941/2016-03-03 14.39.40.jpg" alt="イベント T シャツの背中に印刷されたスポンサー企業各社のロゴ" height="200px"></a></div>
...
- Swift ネイティヴで書いてるはずでも何処かに Objective-C Runtime に依存してしまうことがあって、ここら辺の闇が深くて簡単には解決手法を見付けられず Linux 上で動作させられない事例があるという話。
  - [`Result`](https://github.com/antitypical/Result) （の多分キャスト部分のどこかだと睨んでるんだけど違うかもしれないところの何処か）が Objective-C Runtime に依存してるっぽくて、調べたけどこりゃダメだ、ごめんわからないわｗ とのこと。
...
##### Swift ヒップスター | [@allonsykraken](https://twitter.com/allonsykraken) | [書き起こし](http://niwatako.hatenablog.jp/entry/2016/03/04/131157)
- `lazy var` はクロージャと同じでキャプチャが走るんだけど、一見パッとそうは見えないから気を付けないとリークしちゃうよという話。


##### オープンソース Swift への貢献 | [@jesse_squires](https://twitter.com/jesse_squires) | [書き起こし](http://niwatako.hatenablog.jp/entry/2016/03/04/173304)
